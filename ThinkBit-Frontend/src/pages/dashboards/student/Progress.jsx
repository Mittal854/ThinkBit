...
//           <h4 className="text-lg font-semibold">Total Exams</h4>
//           <p className="text-2xl font-bold">{mockData.length}</p>
//         </div>
//         <div className="bg-gray-800 p-4 rounded-lg shadow-lg text-center">
//           <h4 className="text-lg font-semibold">Best Score</h4>
...
//           <p className="text-2xl font-bold">
//             {(
//               mockData.reduce((sum, d) => sum + d.score, 0) / mockData.length
//             ).toFixed(1)}
//           </p>
//         </div>
//       </div>
...
// // Mock exam data (Replace with API data)
// const mockData = [
//   { name: "Exam 1", score: 80 },
//   { name: "Exam 2", score: 85 },
//   { name: "Exam 3", score: 78 },
...
// const bestScore = Math.max(...mockData.map((d) => d.score));
// const averageScore = (
//   mockData.reduce((sum, d) => sum + d.score, 0) / totalExams
// ).toFixed(1);
// const lastScore = mockData[totalExams - 1].score;
// const prevScore = mockData[totalExams - 2]?.score || lastScore;
// const performanceChange = ((lastScore - prevScore) / prevScore) * 100;
