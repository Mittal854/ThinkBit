...
// import { FaSearch, FaUser, FaClock, FaFilter } from "react-icons/fa";
...
//           />
//         </div>
//         <button className="bg-blue-500 px-4 py-2 rounded-lg flex items-center gap-2 shadow-lg">
//           <FaFilter /> Filter
//         </button>
//       </div>

//       {/* Logs Table */}
//       <div className="bg-gray-900 p-4 rounded-lg shadow-lg overflow-auto">
...
//         </select>
//         <button
//           className="bg-blue-500 px-4 py-2 rounded-lg flex items-center gap-2 shadow-lg hover:bg-blue-600"
//           onClick={exportToCSV}>
//           <FaDownload /> Export
//         </button>
//       </div>
