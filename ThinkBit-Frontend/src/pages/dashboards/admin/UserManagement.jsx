...
//   // Sample users (Replace with API fetch later)
...
//   // Toggle user role between Student & Examiner
//   const toggleRole = (id) => {
//     setUsers(
//       users.map((user) =>
//         user.id === id
...
//           <input
//             type="text"
//             className="w-full p-3 rounded-lg bg-gray-800 border border-gray-600 text-white pl-10"
...
//         </div>
//         <select
//           className="p-3 rounded-lg bg-gray-700 border border-gray-500 text-white"
//           value={filterRole}
...
//               <td className="p-3 border border-gray-600">{user.role}</td>
//               <td className="p-3 border border-gray-600">{user.status}</td>
//               <td className="p-3 border border-gray-600 flex gap-3">
//                 <button
...
//             <input
//               type="text"
//               className="w-full p-2 rounded-lg bg-gray-700 border border-gray-500 text-white mb-3"
//               value={editUser.name}
//               onChange={(e) =>
